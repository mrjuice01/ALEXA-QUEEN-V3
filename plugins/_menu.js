...
┃☠︎︎╭──────────────
┃☠︎︎│ Prefix : ${PREFIX}
┃☠︎︎│ User : ${message.pushName}
┃☠︎︎│ Time : ${date.toLocaleTimeString()}
┃☠︎︎│ Day : ${date.toLocaleString('en', { weekday: 'long' })}
┃☠︎︎│ Date : ${date.toLocaleDateString('hi')}
┃☠︎︎│ Version : ${VERSION}
┃☠︎︎│ Plugins : ${PLUGINS.count}
┃☠︎︎│ Ram : ${getRam()}
┃☠︎︎│ Uptime : ${getUptime('t')}
┃☠︎︎╰───────────────
╰═════════════════⊷
` +
			'```'
